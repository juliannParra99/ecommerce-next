...
// Icons Object
// Contains various SVG icon components utilized throughout the application.
// - 'logo': Represents the logo SVG with multiple paths, ellipses, and circles forming the logo design
//   - Utilizes LucideProps for SVG attributes
//   - Defines paths, ellipses, and circles to create a complex logo design
